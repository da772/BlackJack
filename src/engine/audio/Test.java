...
public class Test {
	...
	public static void main(String[] args) {
		...
		String piano = AudioManager.CreateAudioSource("Piano", "test","Audio/Piano2.wav", 1.f, 1.f, true, true);
		...
		while(running)  {
			...
			if (scanner.hasNextLine()) {
				...
				if (cmd.equals("recreate")) {
					AudioManager.CreateAudioSource("Piano", "Audio/Piano2.wav","test", 1.f, 1.f, true, true);
				}
				if (cmd.equals("play")) {
					AudioManager.PlaySource("Piano");
				}
				if (cmd.equals("yeet")) {
					AudioManager.CreateAudioSource("Yeet",  "Audio/yeet-sound-effect.wav","test", 1.f, 1.f, false, true);
