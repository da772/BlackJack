...
public class TestingApp extends Application {
	...
	protected void OnInit() {
		...
		background = new Mesh(vertices1, new VertexArray.BufferElement[]{
				...
				}, indices1, new Shader(ShaderLib.Shader_U_Texture_ViewProj_UV_Transform_L_V3Pos_V2Coord),
				new Texture("Images/mosaico_multicolor_tile.jpg"),
		...
		indices, new Shader(ShaderLib.Shader_U_Texture_ViewProj_Transform_L_V3Pos_V2Coord), 
		new Texture("Images/Anchor.png"),
		transform, cam.GetCamera());
		...
		indices1, new Shader(ShaderLib.Shader_U_Texture_ViewProj_Transform_L_V3Pos_V2Coord),
		new Texture("Images/2_of_diamonds.png"),
		transform, cam.GetCamera());
		
		pos = new Vector3f(0f,-.5f,-1f);
