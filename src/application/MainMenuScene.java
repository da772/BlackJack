	...
	public void OnBegin() {
		...
		Actor.Create("StartButton", this).AddComponent(new GUIButton(
				"DraggableQuad",new Transform( 
						...
						new Vector2f(.875f, -.9425f), // Font Offset (used to center text if needed) 
