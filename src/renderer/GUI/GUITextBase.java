...
public class GUITextBase extends GUI {
	...
	public GUITextBase(String name, String text, float fontSize, String font,  Transform transform, Vector4f color, float maxLineLength,
			boolean centered) {
		super(name);
